...
function getDefaultContent(){
  return {
    ...
    hero_subtitle: 'Luxe Scottsdale Oasis near Old Town — 4 Bed · 2 Bath · Sleeps 8',
...
router.get('/site-content', async (_req, res) => {
  try{
    ...
    try {
      ...
      const forcedSubtitle = 'Luxe Scottsdale Oasis near Old Town — 4 Bed · 2 Bath · Sleeps 8';
      ...
      content.hero_subtitle = forcedSubtitle;
    } catch {}
